	...
	var Slider = function(element, options) {
		...
		switch(this.orientation) {
			...
			default:
				...
				this.tooltip_min.addClass('top')[0].style.top = -this.tooltip_min.outerHeight() - 28 + 'px';
				this.tooltip_max.addClass('top')[0].style.top = -this.tooltip_max.outerHeight() - 28 + 'px';
				break;
		}
